...
(0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.accordion .accordion-head').accordion();
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.carousel = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    let offset = 0;
    let slideIndex = 0;
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(next).click(e => {
      e.preventDefault();
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(prev).click(e => {
      e.preventDefault();
      if (offset == 0) {
    ...
    const innerListiner = (triggerSelector, typeEvent, stateInterval) => {
      (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(triggerSelector).on(typeEvent, e => {
        if (stateInterval) {
          autoplaySlides();
        } else {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createCarousel = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    for (let j = 0; j < slides.count; j++) {
      ...
      slider.querySelectorAll('.carousel-item').forEach(item => {
        if ((0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(item).index() == j) {
          item.append(img);
        }
      });
  ...
  (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(`#${slides.sliderAttr}`).carousel();
};
(0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])('.container').createCarousel({
  size: {
    width: 600,
    height: 400
  },
  slides: {
    count: 3,
    settings: [["https://variety.com/wp-content/uploads/2018/09/witcher-card-game-e1537278354978.jpg?w=1024", "photo"], ["https://images.pushsquare.com/a107d13f1b6a1/the-witcher-3-yennefer-romance.large.jpg", "photo"], ["https://cdn.mos.cms.futurecdn.net/wqRQ8hJmvwLVycDJham9qF.jpg", "photo"]],
    btnPrevNext: true,
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core */ "./src/js/lib/core.js");
/* harmony import */ var _dropdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dropdown */ "./src/js/lib/components/dropdown.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modal */ "./src/js/lib/components/modal.js");
/* harmony import */ var _tab__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tab */ "./src/js/lib/components/tab.js");
/* harmony import */ var _accordion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./accordion */ "./src/js/lib/components/accordion.js");
/* harmony import */ var _carousel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./carousel */ "./src/js/lib/components/carousel.js");
...
/* harmony import */ var _components_ui__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/ui */ "./src/js/lib/components/ui.js");
/* harmony import */ var _services_request__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/request */ "./src/js/lib/services/request.js");
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => (0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    ...
    settings: [['Close', ['btn-danger', 'mr-10'], true], ['Save changes', ['btn-success'], false, () => {
      alert('Data saved');
    }], ['another btn', ['btn-dark', 'ml-10'], false, () => {
      alert('another btn');
    }]]
  }
}));
